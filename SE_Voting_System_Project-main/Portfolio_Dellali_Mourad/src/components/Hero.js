...
const Hero = () => {
  ...
  // Throttle mousemove using requestAnimationFrame to reduce rerenders
  useEffect(() => {
    let rafId = null;
    const pos = { x: 0, y: 0 };
  ...
  // Generate random particles (memoized to avoid re-creation on each render)
  ...
  // Split the text for animated entrance
